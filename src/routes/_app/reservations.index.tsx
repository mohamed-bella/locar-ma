...
function Reservations() {
  ...
  // Calendar keeps the quick-edit drawer; the table opens the full detail page.
  function openReservationDrawer(r: Reservation) {
    setDrawer({
      open: true,
      initial: {
        id: r.id,
  ...
  function openReservationDetail(r: Reservation) {
    navigate({ to: '/reservations/$reservationId', params: { reservationId: r.id } })
  }
  ...
  return (
    <div>
      ...
      {activeTab === 'calendar' ? (
        ...
        <div className="mt-4">
          <ReservationTable reservations={reservations} vehicles={vehicles} onOpen={openReservationDetail} />
        </div>
      )}
